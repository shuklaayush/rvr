...
impl<X: Xlen> BufferedDiffTracer<X> {
    ...
    pub fn setup(&mut self, buffer: *mut DiffEntry<X>, capacity: u32) {
        self.buffer = buffer;
    ...
    pub fn iter(&self) -> BufferedDiffIterator<'_, X> {
...
impl<'a, X: Xlen> ExactSizeIterator for BufferedDiffIterator<'a, X> {}
...
mod tests {
    ...
    fn test_buffered_diff_tracer_iteration() {
        ...
        buffer[0].pc = 0x1000;
        buffer[0].opcode = 0x00000013; // NOP
        buffer[1].pc = 0x1004;
