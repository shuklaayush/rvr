...
mod tests {
    ...
    fn test_rv64_state_layout() {
        ...
        // and openvm-mojo's RvMachine layout exactly.
        ...
        // No target_instret here - it's now in suspender at the end
    ...
    fn test_rv64_state_with_instret_suspender() {
        // When suspender is InstretSuspender (8 bytes), it adds at the end
        ...
        // Suspender offset is at start_brk + 8
        assert_eq!(offset_of!(StateWithSuspender, suspender), 33096);
    }
