//! SuspendRunner - runner with instret suspension for single-stepping.

use std::ffi::c_void;

use rvr_elf::ElfImage;
use rvr_ir::Xlen;
use rvr_state::{GuardedMemory, InstretSuspender, RvState};
...
pub struct SuspendRunner<X: Xlen, const NUM_REGS: usize> {
